...
constexpr std::array< bmp::point< double >, 4 > from
	{{{84, 93}, {166, 100}, {90, 210}, {163, 200}}};
constexpr std::array< bmp::point< double >, 4 > to
...
TEST(RectTransformTest, ImageContour){
	...
	EXPECT_EQ(ic, (bmp::rect< long, std::size_t >(-1, -3, 62, 47)));
	...
	auto const target_d =
		bmp::transform_bitmap< double >(invert(c), source, ic);
